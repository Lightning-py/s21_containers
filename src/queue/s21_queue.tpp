...
template <class T, class Container> queue<T, Container>::~queue() {}
...
queue<T, Container>::front() const noexcept {
  return container_.front();
}

template <class T, class Container>
typename queue<T, Container>::const_reference
queue<T, Container>::back() const noexcept {
...
queue<T, Container>::size() const noexcept {
...
template <class T, class Container> void queue<T, Container>::pop() {
